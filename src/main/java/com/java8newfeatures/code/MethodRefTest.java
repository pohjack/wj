 ...
 * @author: wj
 * @version: v1
 * @date:2018年8月12日 上午9:52:45
 * @description:java8新特性-方法引用，构造器引用，数组引用
 */
public class MethodRefTest {
	 ...
	 * ②使用类名：：实例方法时，若Lambda的参数列表的第一个参数，是实例方法的调用者，第二个参数(或无参)是实例方法的参数时，格式： ClassName::MethodName
	 * 
	...
	@Test
	public void test2() {
		Employee emp = new Employee(101, 18, "张三");
